...
public class SparksTelemetryManager {
    ...
    public SparksTelemetryManager(Context applicationContext) {
    ...
    public WritableMap getBinaryUpdateReport(String appVersion) {
        ...
        if (previousStatusReportIdentifier == null) {
            ...
            this.clearRetryStatusReport();
            reportMap = Arguments.createMap();
            if (this.isStatusReportIdentifierSparksLabel(previousStatusReportIdentifier)) {
    ...
    public WritableMap getRetryStatusReport() {
        ...
        if (retryStatusReportString != null) {
            ...
            try {
                ...
                return SparksUtils.convertJsonObjectToWritable(retryStatusReport);
    ...
    public void saveStatusReportForRetry(ReadableMap statusReport) {
        JSONObject statusReportJSON = SparksUtils.convertReadableToJsonObject(statusReport);
    ...
    private String getPackageStatusReportIdentifier(ReadableMap updatePackage) {
        ...
        String deploymentKey = SparksUtils.tryGetString(updatePackage, DEPLOYMENT_KEY_KEY);
        String label = SparksUtils.tryGetString(updatePackage, LABEL_KEY);
    ...
    private boolean isStatusReportIdentifierSparksLabel(String statusReportIdentifier) {

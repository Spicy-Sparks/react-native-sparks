...
public class SparksDialog extends ReactContextBaseJavaModule{

    public SparksDialog(ReactApplicationContext reactContext) {
        super(reactContext);
    }
                ...
                try {
                    ...
                    switch (which) {
                        ...
                        case DialogInterface.BUTTON_NEGATIVE:
                            ...
                            break;
                        default:
                            throw new SparksUnknownException("Unknown button ID pressed.");
                    }
                } catch (Throwable e) {
                    SparksUtils.log(e);
                }

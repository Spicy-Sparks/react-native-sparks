...
public class SparksConstants {
    ...
    public static final String CODE_PUSH_HASH_FILE_NAME = "SparksHash";
    public static final String CODE_PUSH_OLD_HASH_FILE_NAME = "SparksHash.json";
    ...
    public static final String FAILED_UPDATES_KEY = "SPARKS_FAILED_UPDATES";
    ...
    public static final String PENDING_UPDATE_KEY = "SPARKS_PENDING_UPDATE";
    ...
    public static final String STATUS_FILE = "Sparks.json";
    public static final String UNZIPPED_FOLDER_NAME = "unzipped";
    public static final String CODE_PUSH_APK_BUILD_TIME_KEY = "SPARKS_APK_BUILD_TIME";
    public static final String BUNDLE_JWT_FILE = ".Sparksrelease";
